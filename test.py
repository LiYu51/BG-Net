...
def parse_args():
    ...
    parser.add_argument('--name', default='2022_1212-XR1800',
                        help='model name')
...
def main():
    with open(
            'E:/project/project/pytorch_nested_unet_master/pytorch_nested_unet_master/models/2022_1212-XR1800/config.yml',
            'r') as f:
    ...
    model.load_state_dict(torch.load(
        'E:/project/project/pytorch_nested_unet_master/pytorch_nested_unet_master/models/2022_1212-XR1800/model.pth'))
    model.eval()
